...
## Games
- [Practice Python Challenges](https://github.com/kevinveeder/code-challenge-arena) - practice python coding anywhere on your local device (built with python and claude code assistance)
